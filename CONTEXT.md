...
*Avoid*: "the consumers" as a plural standing in for measurement. The pair is two named repos, and `uxlab` is a consumer that is not one of them — name the repos a finding was measured against rather than letting the plural stand for them.
